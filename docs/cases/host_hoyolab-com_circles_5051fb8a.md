...
status: ✅ 수동 config (bbs-api-os getNewsList gids=6, 15건 baseline)
outcome: improved
date: 2026-05-19
fix_layer: F
...
차이: 첫 batch 에선 BUG (subprocess_timeout, SW assertion crash). SW launch arg fix 후 정상 → 수동 config 박음.
